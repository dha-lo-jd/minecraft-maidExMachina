...
public class MEMPlanDefault20121224 {
	...
	public static final IMEMPlanBlockInfo[][] HAIR_PARTS_Y0 = new IMEMPlanBlockInfo[][] {
			...
			{ _VD_, _VD_, _VD_, HAas, HAbs, HAbs, HAcs, _VD_, _VD_, _VD_, },
			{ _VD_, _VD_, _VD_, HAat, HAbt, HAbt, HAct, _VD_, _VD_, _VD_, },//
	};
	public static final IMEMPlanBlockInfo[][] HAIR_PARTS_Y1 = new IMEMPlanBlockInfo[][] {
			...
			{ _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, },
			{ _VD_, _VD_, _VD_, HAds, _VD_, _VD_, HAfs, _VD_, _VD_, _VD_, },
			{ _VD_, _VD_, _VD_, HAdt, HAet, HAet, HAft, _VD_, _VD_, _VD_, },//
	};
	...
	public static final IMEMPlanBlockInfo[][] HAIR_PARTS_Y3 = new IMEMPlanBlockInfo[][] {
			...
			{ _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, },
			{ _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, },
			{ _VD_, _VD_, _VD_, HAgs, HAhs, HAhs, HAis, _VD_, _VD_, _VD_, },
			{ _VD_, _VD_, _VD_, HAgt, HAht, HAht, HAit, _VD_, _VD_, _VD_, },//
	};

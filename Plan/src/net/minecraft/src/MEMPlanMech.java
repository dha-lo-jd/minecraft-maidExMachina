...
public class MEMPlanMech {

	public static final IMEMPlanBlockInfo _VD_ = null;

	public static final int HEAR = 0x241808;
	public static final int SKIN = 0xdedede;
	...
	public static final int[] EYE = new int[] { 0xffff00, 0xffff00, 0xffff00,
			0xffff00 };
	// dedede
	// 000020
	...
	public static final int[] __W = new int[] { 4 };
	public static final int[] __E = new int[] { 5 };
	...
	private static IMEMPlanBlockInfo I(int color, int[] faces) {
		Integer[] colors = MEMPlanOptionalQuadFrame.getFaceArray(color, null,
				new Integer[] {}, faces);
		return new MEMPlanOptionalQuadFrame(defaultFrame, colors, null);
	}
	...
	public static final IMEMPlanBlockInfo H_1_ = I(HEAR, TNE);
	public static final IMEMPlanBlockInfo H_2_ = I(WHT_, TN_);
	public static final IMEMPlanBlockInfo H_3_ = I(HEAR, TNW);
	public static final IMEMPlanBlockInfo H_4_ = I(HEAR, T_E);
	public static final IMEMPlanBlockInfo H_5_ = I(HEAR, T__);
	public static final IMEMPlanBlockInfo H_6_ = I(HEAR, T_W);
	public static final IMEMPlanBlockInfo H_7_ = I(HEAR, TSE);
	public static final IMEMPlanBlockInfo H_8_ = I(HEAR, TS_);
	public static final IMEMPlanBlockInfo H_9_ = I(HEAR, TSW);

	public static final IMEMPlanBlockInfo H_a_ = I(HEAR, null, WHT_, null,
			null, null);

	public static final IMEMPlanBlockInfo H10_ = I(HEAR, _NE);
	public static final IMEMPlanBlockInfo H11_ = I(WHT_, _N_);
	public static final IMEMPlanBlockInfo H11a = I(HEAR, _N_);
	public static final IMEMPlanBlockInfo H12_ = I(HEAR, _NW);
	public static final IMEMPlanBlockInfo H13_ = I(HEAR, __E);
	public static final IMEMPlanBlockInfo H14_ = I(HEAR, __W);
	public static final IMEMPlanBlockInfo H15_ = I(HEAR, _SE);
	public static final IMEMPlanBlockInfo H16_ = I(HEAR, _S_);
	public static final IMEMPlanBlockInfo H17_ = I(HEAR, _SW);
	...
	public static final IMEMPlanBlockInfo H36_ = I(HEAR, B_E);
	public static final IMEMPlanBlockInfo H37_ = I(HEAR, B__);
	public static final IMEMPlanBlockInfo H38_ = I(HEAR, B_W);
	public static final IMEMPlanBlockInfo H39_ = I(HEAR, BSE);
	public static final IMEMPlanBlockInfo H40_ = I(HEAR, BS_);
	public static final IMEMPlanBlockInfo H41_ = I(HEAR, BSW);

	public static final IMEMPlanBlockInfo H40a = I(HEAR, HEAR, null, HEAR,
			null, null);
	...
	public static final IMEMPlanBlockInfo[][][] HEAD = new IMEMPlanBlockInfo[][][] {//
			{
					...
					{ H_4_, H_5_, H_5_, H_5_, H_5_, H_5_, H_5_, H_6_, },
					{ H_4_, H_5_, H_5_, H_5_, H_5_, H_5_, H_5_, H_6_, },
					{ H_4_, _VD_, H_5_, H_5_, H_5_, H_5_, H_5_, H_6_, },
				...
				//
					...
					{ H13_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, H14_, }, //
					{ H13_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, H14_, }, //
					{ H15_, H16_, H16_, _VD_, _VD_, H16_, H16_, H17_, },//
			}, {//
				//
				...
				//
					...
					{ H36_, H37_, H37_, H37_, H37_, H37_, H37_, H38_, },
					{ H36_, H37_, H37_, H37_, H37_, H37_, H37_, H38_, },
					{ H39_, H40_, H40_, H40a, H40a, H40_, H40_, H41_, },//
			}, };
	...
	public static final IMEMPlanBlockInfo[][][] SKIRT = new IMEMPlanBlockInfo[][][] {//
			...
			},
			{
					...
					{ S_4_, S_5_, S_5a, S_5_, S_5_, S_5a, S_5_, S_6_, },
					{ S_4_, S_5_, S_5a, S_5_, S_5_, S_5a, S_5_, S_6_, },
					{ S_4a, S_5_, S_5a, S_5a, S_5a, S_5a, S_5_, S_6a, },
					{ S_4b, S_5b, S_5b, S_5b, S_5b, S_5b, _VD_, S_6b, },
					{ S_7_, S_8_, S_8_, S_8a, S_8a, S_8_, S_8_, S_9_, }, //
			}, {
					// y2
					...
					{ S14_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, S16_, }, //
					{ S14_, _VD_, _VD_, _VD_, _VD_, _VD_, _VD_, S16_, }, //
					{ S17_, S18b, S18b, S18_, S18_, S18b, S18b, S19_, }, //
			}, {
					// y4

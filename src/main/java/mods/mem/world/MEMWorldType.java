...
public class MEMWorldType
{
    /** List of world types. */
    public static MEMWorldType[] worldTypes = new MEMWorldType[16];
    /** Default world type. */
    public static final MEMWorldType DEFAULT = (new MEMWorldType(0, "default", 1)).setVersioned();
    /** Flat world type. */
    public static final MEMWorldType FLAT = new MEMWorldType(1, "flat");
    /** Large Biome world Type. */
    public static final MEMWorldType LARGE_BIOMES = new MEMWorldType(2, "largeBiomes");
    /** amplified world type */
    public static final MEMWorldType AMPLIFIED = (new MEMWorldType(3, "amplified")).setNotificationData();
    /** Default (1.1) world type. */
    public static final MEMWorldType DEFAULT_1_1 = (new MEMWorldType(8, "default_1_1", 0)).setCanBeCreated(false);
    ...
    private MEMWorldType(int p_i1959_1_, String p_i1959_2_)
    {
        this(p_i1959_1_, p_i1959_2_, 0);
    }

    private MEMWorldType(int p_i1960_1_, String p_i1960_2_, int p_i1960_3_)
    {
    ...
    public MEMWorldType getWorldTypeForGeneratorVersion(int p_77132_1_)
    {
     ...
     */
    private MEMWorldType setCanBeCreated(boolean p_77124_1_)
    {
     ...
     */
    private MEMWorldType setVersioned()
    {
    ...
    public static MEMWorldType parseWorldType(String p_77130_0_)
    {
     ...
     */
    private MEMWorldType setNotificationData()
    {
...
*/
     ...
     * @param name
     */
    public MEMWorldType(String name)
    {
        this(getNextID(), name);
    }

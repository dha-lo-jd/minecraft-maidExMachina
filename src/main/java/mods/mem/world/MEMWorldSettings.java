...
public final class MEMWorldSettings
{
    /** The seed for the map. */
    private final long seed;
    /** The EnumGameType. */
    private final MEMWorldSettings.GameType theGameType;
    ...
    public MEMWorldSettings(long p_i1957_1_, MEMWorldSettings.GameType p_i1957_3_, boolean p_i1957_4_, boolean p_i1957_5_, WorldType p_i1957_6_)
    {
        this.field_82751_h = "";
    ...
    public MEMWorldSettings(WorldInfo p_i1958_1_)
    {
     ...
     */
    public MEMWorldSettings enableBonusChest()
    {
        this.bonusChestEnabled = true;
        return this;
    }

    public MEMWorldSettings func_82750_a(String p_82750_1_)
    {
    ...
    public MEMWorldSettings enableCommands()
    {
     ...
     * Gets the game type.
     */
    public MEMWorldSettings.GameType getGameType()
    {
     ...
     */
    public static MEMWorldSettings.GameType getGameTypeById(int p_77161_0_)
    {
        return MEMWorldSettings.GameType.getByID(p_77161_0_);
    }
    ...
    public static enum GameType
    {
         ...
         */
        public static MEMWorldSettings.GameType getByID(int p_77146_0_)
        {
            MEMWorldSettings.GameType[] agametype = values();
            int j = agametype.length;

            for (int k = 0; k < j; ++k)
            {
                MEMWorldSettings.GameType gametype = agametype[k];
         ...
         */
        @SideOnly(Side.CLIENT)
        public static MEMWorldSettings.GameType getByName(String p_77142_0_)
        {
            MEMWorldSettings.GameType[] agametype = values();
            ...
            for (int j = 0; j < i; ++j)
            {
                MEMWorldSettings.GameType gametype = agametype[j];

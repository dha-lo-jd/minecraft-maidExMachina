...
public class MEMEntityCore extends EntityTameable
{
    ...
    public MEMEntityCore(World p_i1696_1_)
    {
        super(p_i1696_1_);
    ...
    public MEMEntityCore createChild(EntityAgeable p_90011_1_)
    {
        MEMEntityCore entitywolf = new MEMEntityCore(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal p_70878_1_)
    {
        ...
        else if (!(p_70878_1_ instanceof MEMEntityCore))
        {
            return false;
        }
        else
        {
            MEMEntityCore entitywolf = (MEMEntityCore)p_70878_1_;
    ...
    public boolean func_142018_a(EntityLivingBase p_142018_1_, EntityLivingBase p_142018_2_)
    {
        ...
        {
            if (p_142018_1_ instanceof MEMEntityCore)
            {
                MEMEntityCore entitywolf = (MEMEntityCore)p_142018_1_;
